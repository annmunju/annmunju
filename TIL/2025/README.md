...
- Chapter 2. 데이터 표현 디자인 패턴
	- [서론](ML_design_pattern/2(1).md) (2025. 09. 30)  
	- [(1) 간단한 데이터 표현](ML_design_pattern/2(1).md) (2025. 10. 13)
	- [(2) 디자인 패턴 1: 특징 해시](ML_design_pattern/2(2).md) (2025. 10. 14)
	- [(3) 디자인 패턴 2: 임베딩](ML_design_pattern/2(2).md) (2025. 10. 22)
	- [(4) 디자인 패턴 3: 특징 교차](ML_design_pattern/2(3).md) (2025. 11. 05)
	- [(5) 디자인 패턴 4: 멀티모달 입력](ML_design_pattern/2(4).md) (2025. 11. 06)
- Chapter 3. 문제 표현 디자인 패턴
	- [(1) 디자인 패턴 5: 리프레이밍](ML_design_pattern/3(1).md) (2025. 11. 07)
	- [(2) 디자인 패턴 6: 멀티라벨](ML_design_pattern/3(2).md) (2025. 11. 10)
	- [(3) 디자인 패턴 7: 앙상블](ML_design_pattern/3(3).md) (2025. 11. 12)  
	- [(4) 디자인 패턴 8: 캐스케이드](ML_design_pattern/3(4).md) (2025. 12. 09)
...
- Chapter 8. 연결 패턴
